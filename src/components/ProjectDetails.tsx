...
const ProjectDetails: React.FC<ProjectDetailsProps> = ({
  ...
  return (
    <section className="mb-12">
      ...
      {images.length > 0 && (
        <>
          <div className="relative mb-4 w-full xl:w-1/2 h-64 md:h-96 bg-white overflow-hidden rounded-md shadow-lg border border-gray-300 dark:border-gray-600">
          ...
          <div className="w-full xl:w-1/2 flex justify-center space-x-2 mt-4 mb-4">
            {images.map((_, index) => (
              <span
                key={index}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 xl:w-1/2">
        <a
